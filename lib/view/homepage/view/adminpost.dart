  ...
  Widget build(BuildContext context) {
    return Obx(
      () => SizedBox(
        ...
        child: userPostListController.data.isEmpty
            ? Center(
                      ...
                      child: Column(
                        ...
                        children: [
                            ...
                            children: [
                              ...
                              GestureDetector(
                                ...
                                child: SizedBox(
                                  ...
                                  // color: Colors.amber,
                                  child: Text(
                                    userPostListController.data[index].username
                                        .toString(),
                          ...
                          Padding(
                            ...
                            child: Text(
                              userPostListController.data[index].description
                                  .toString(),
                              style: GoogleFonts.poppins(
                                textStyle: TextStyle(
                                  fontSize: 9.5.sp,
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: [
                                Text(
                                  userPostListController.data[0].likecount
                                      .toString(),
                                  style: GoogleFonts.poppins(
                                    textStyle: TextStyle(
                                      fontSize: 9.0.sp,
                                ...
                                Expanded(child: Container()),
                                Text(
                                  userPostListController.data[0].postViewCount
                                      .toString(),
                                  style: GoogleFonts.poppins(
                                    textStyle: TextStyle(
                                      fontSize: 9.0.sp,
