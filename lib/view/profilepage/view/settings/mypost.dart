...
class _My_Post_UIState extends State<My_Post_UI> {
  ...
  @override
  void initState() {
    currentUserlistController.getmyProfilelist(widget.id);
  ...
  Widget build(BuildContext context) {
    return Scaffold(body: Obx(() {
      if (currentUserlistController.iscurrentpostloading.value) {
        ...
        return const Center(
          child: Text("Currently No Post"),
        );
      } else {
        var data = currentUserlistController.currentuserlist[0];
        return SafeArea(
          child: Column(
            children: [
              AppbarContainer(
                        ...
                        children: [
                            ...
                            children: [
                              ...
                              CircleAvatar(
                                backgroundImage: NetworkImage(
                                    data.data![index].profileicon.toString()),
                              ),
                              const SizedBox(
                                width: 5,
                              ),
                          ...
                          VisibilityDetector(
                            ...
                            child: GestureDetector(
                                child: MediaWidget(
                              mediaType: data.data![index].posttype.toString(),
                              source: data.data![index].addImagesOrVideos
                                  .toString(),
                            )),
                          ),
                          // Container(
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: [
                                Text(
                                  "${data.data![index].likeCount.toString()} Likes",
                                  style: GoogleFonts.poppins(
                                    textStyle: TextStyle(
                                      fontSize: 9.0.sp,
